...
-- failed in _prisma_migrations (started_at 2026-03-06 12:28:21.272147 UTC, no
-- finished_at). Prisma error P3009 blocks all subsequent migrations until the
-- failed entry is resolved.
--
-- Strategy:
--   1. Mark the failed migration as rolled back in _prisma_migrations so Prisma
--      stops treating it as a blocker.
